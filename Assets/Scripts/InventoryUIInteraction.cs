...
public class InventoryUIInteraction : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerExitHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        if (transform.GetComponent<Slots>().ItemInSlot == null)
            return;
        print("Begin Drag");
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        draggedItemParent.GetComponent<Slots>().SetStats();
        draggedItem = null;
    ...
    {
        if (eventData.pointerClick.GetComponent<Slots>().ItemInSlot == null || ClickedItemUI.activeInHierarchy)
            return;
